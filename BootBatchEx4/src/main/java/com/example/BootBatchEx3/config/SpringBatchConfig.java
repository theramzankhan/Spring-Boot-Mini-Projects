...
import com.example.BootBatchEx3.repository.CustomerRepository;
...
public class SpringBatchConfig {
	...
	@Autowired
    private CustomerRepository customerRepository; // Spring Data JPA repository
...
//	For writing as well as logging purpose
	// Writer: Writing data using JPA (via JpaItemWriter)
//    

	@Bean
	public ItemWriter<Customer> itemWriter() {
	    // Logging writer
	    ItemWriter<Customer> loggingWriter = items -> {
	    ...
	    // JPA writer
	    JpaItemWriter<Customer> jpaItemWriter = new JpaItemWriterBuilder<Customer>()
	            .entityManagerFactory(entityManagerFactory)
	            .build();

	    // Composite writer
	    CompositeItemWriter<Customer> compositeItemWriter = new CompositeItemWriter<>();
	    compositeItemWriter.setDelegates(List.of(loggingWriter, jpaItemWriter));
