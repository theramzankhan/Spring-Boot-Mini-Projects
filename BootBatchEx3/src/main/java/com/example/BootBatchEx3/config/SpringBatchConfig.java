		...
		return new StepBuilder("jobStep", jobRepository)
				...
				.listener(new ChunkListener() {
					...
					public void beforeChunk(ChunkContext context) {
						synchronized (this) {
							count++;
							System.out.println("Before processing a chunk, chunk no: " + count);
						}
					}
					
					@Override
					public void afterChunk(ChunkContext context) {
						System.out.println("Finished processing a chunk, chunk no: " + count + " successfully.");
					}
					
					@Override
					public void afterChunkError(ChunkContext context) {
						System.out.println("Error occurred while processing a chunk, chunk no: " + count + "!");
					}
				})
				.build();
	}
...
//	For writing as well as logging purpose
	...
	public TaskExecutor taskExecutor() {
		...
		asyncTaskExecutor.setConcurrencyLimit(10); // You can tune this value
